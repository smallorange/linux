...
struct sh_css_sp_group_2400 {
	struct sh_css_sp_config_2400 config;
...
union sh_css_sp_group {
	struct sh_css_sp_group_2400 sp_group_2400;
	struct sh_css_sp_group_2401 sp_group_2401;
};


static inline int get_sp_group_length (void)
{
	if (IS_ISP2401)
		return sizeof(struct sh_css_sp_group_2401);
	else
		return sizeof(struct sh_css_sp_group_2400);
}
